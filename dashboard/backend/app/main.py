...
/api/health requires a valid session; google_api_key additionally requires
the admin role -- see app/auth.py."""

from fastapi import Depends, FastAPI

from . import auth
from .routers import auth_routes, github_credentials, google_api_key, runs, sonar_servers, users
...
app.include_router(google_api_key.router, dependencies=[Depends(auth.require_admin)])
