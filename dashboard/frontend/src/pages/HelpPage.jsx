    ...
    <div className="help-page">
      ...
      <div className="help-layout">
        <div className="help-main">
          ...
          <section>
            <h3>2. Make sure the repo has a Sonar analysis already</h3>
            <p>
              The agent only <em>reads</em> existing Sonar issues — it doesn't run the repo's first
              scan for you. If the project has never been analyzed on that Sonar server before, the
              run stops immediately with a clear error instead of proceeding with nothing to fix.
              Run an initial scan from the target repo first:
            </p>
            <pre>
              <code>
                {'# Maven\n'}
            ...
            <p>
              Once that first scan shows up on the Sonar server, come back here and start the run
              normally — every scan after the first one is the agent's job, not yours.
            </p>
          </section>
          ...
          {isAdmin && (
            <section>
              <h3>5. Managing users (admin only)</h3>
              <p>
                ...
                in immediately (after choosing their own password — new accounts must reset the
                temporary one you gave them on first login). You can delete any account except your
                own.
              </p>
            </section>
          )}
        ...
        <aside className="help-aside">
          ...
          <section>
            ...
            <ul>
              ...
              <li>
                <strong>"Project key has no analysis on this Sonar server yet"</strong> — run the
                repo's first scan yourself (see step 2), then retry.
              </li>
              <li>
